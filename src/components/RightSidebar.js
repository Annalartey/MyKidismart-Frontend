...
import NewStageForm from './NewStage'
import NewKidForm from './NewKid';

const RightSidebar = ({ toggleNewKidForm, addingKid, saveNewKid, saveNewStage }) => {
  return (
          ...
          <div className="h-full flex flex-col py-6 bg-white shadow-xl overflow-y-scroll">
            <div className="px-4 sm:px-6">
              <h2 id="slide-over-heading" className="text-lg font-medium text-gray-900">
                Create a {addingKid ? 'Customer' : 'Stage'}
              </h2>
            </div>
            <div className="mt-6 relative flex-1 px-4 sm:px-6">
              ...
              <div className="absolute inset-0 px-4 sm:px-6">
                <div className="h-full" aria-hidden="true">
                  {
                    addingKid?
                      <NewKidForm saveKid={saveNewKid} />
                      :
                      <NewStageForm saveStage={saveNewStage} />
                  }
                </div>
              </div>
              {/* <!-- /End replace --> */}
