...
import imgEight2 from './../images/eight2.jpg'
// import LearnPage from './LearnPage'
// import logo from './../images/logo.png'

const FirstHome = () => {
  return (
    <header className="bg-center bg-cover" style={{backgroundImage: `url(${imgEight2})`}}>
      <div className="h-screen flex flex-col justify-start px-12 py-8">
        <div className="flex flex-col lg:flex-row w-full lg:justify-between items-start lg:items-center space-y-6 lg:space-y-0">
          ...
          <div className="w-full lg:w-1/2 justify-center lg:justify-end lg:text-right py-2 flex space-x-6 text-lg">
            <a href="/signup" className=" py-1 text-white font-semibold border-b-2 hover:border-green-400 transition duration-500 ease-in-out hover:border-b-2 transform hover:-translate-y-1 hover:scale-110 ">Sign Up</a>
        ...
        <div className="text-center my-40 lg:my-56">
          <h1 className="text-6xl font-bold text-gray-700 mb-20 text-shadow-xl">Fun Learning For Kids</h1>
          <a href="/home" className="border-2 border-green-400 px-2 text-lg font-bold text-gray-900 hover:tect-green-400 hover:bg-white">Learn More</a>
        </div>
